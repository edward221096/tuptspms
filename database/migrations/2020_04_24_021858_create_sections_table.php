...
class CreateSectionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('sections')->insert([
            ...
            ['id' => 16, 'dept_id'=> 7, 'section_name' => 'Faculty'],
            ['id' => 17, 'dept_id' => 8, 'section_name' => 'Campus Director Department'],
            ['id' => 18, 'dept_id' => 9, 'section_name' => 'ADAA'],
            ['id' => 19, 'dept_id' => 10, 'section_name' => 'ADAF'],
            ['id' => 20, 'dept_id' => 11, 'section_name' => 'ADRE'],
            ['id' => 21, 'dept_id'=> 12,  'section_name' => 'Accounting'],
            ['id' => 22, 'dept_id'=> 13 , 'section_name' => 'Budget'],
            ['id' => 23, 'dept_id'=> 14 , 'section_name' => 'Cashier'],
            ['id' => 24, 'dept_id'=> 15 , 'section_name' => 'IDO'],
            ['id' => 25, 'dept_id'=> 16 , 'section_name' => 'Industry Based'],
            ['id' => 26, 'dept_id'=> 17 , 'section_name' => 'Medical Service'],
            ['id' => 27, 'dept_id'=> 18 , 'section_name' => 'PDO'],
            ['id' => 28, 'dept_id'=> 19 , 'section_name' => 'Procurement'],
            ['id' => 29, 'dept_id'=> 20 , 'section_name' => 'QAA'],
            ['id' => 30, 'dept_id'=> 21 , 'section_name' => 'Records'],
            ['id' => 31, 'dept_id'=> 22 , 'section_name' => 'UITC'],
        ]);
    }
