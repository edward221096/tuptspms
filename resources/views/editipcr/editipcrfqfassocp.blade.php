                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('updatemyipcropcr.update', [$row->form_sequence_id])}}" method="post">
                            ...
                            <div style="position: absolute; right: 0;">
                                <a href="{{action('PrintformController@pdfexportipcrfqfassocp', $row->form_sequence_id)}}" class="fas fa-print nav-icon fa-2x"></a>
                            </div>
                            <label>
                            ...
                            >
                                ...
                                <tr style="box-sizing: border-box; height: 2.9pt;">
                                    ...
                                    <td width="254" style="box-sizing: border-box; border-top: none; border-left: none; border-bottom: 1pt solid rgb(191, 191, 191); border-right: 1pt solid rgb(191, 191, 191); padding: 0cm 5.4pt;">
                                        <p align="center" style="box-sizing: border-box; margin: 0cm 0cm 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; text-align: center;"><br />Choose 3 QO in instruction; 3 QO in research/extension; choose all for quasi/admin; with Graduate Program QO if applicable</p>
                                    </td>
                                </tr>
                                <tr style="box-sizing: border-box;">
                                    ...
                                    <td width="254" style="box-sizing: border-box; border-top: none; border-left: none; border-bottom: 1pt solid rgb(191, 191, 191); border-right: 1pt solid rgb(191, 191, 191); padding: 0cm 5.4pt; width: 524px;">
                                        <p style="box-sizing: border-box; margin: 6pt 0cm; font-size: 11pt; font-family: Calibri, sans-serif; line-height: 12.65pt;">
                                            <span style="box-sizing: border-box; font-size: 10pt; font-family: Arial, sans-serif; color: black;">Choose 3 QO in instruction; 3 QO in research/extension; choose all for quasi/admin; with Graduate Program QO if applicable</span>
                                        </p>
                                        <p style="box-sizing: border-box; margin: 6pt 0cm; font-size: 11pt; font-family: Calibri, sans-serif; line-height: 12.65pt;">
