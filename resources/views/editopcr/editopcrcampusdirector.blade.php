...
<head>
    ...
    <form method="POST" action="{{route('updatemyipcropcr.update', [$row->form_sequence_id])}}">
        ...
        <div style="position: absolute; right: 0;">
            <a href="{{action('PrintformController@pdfexportopcrcampusdirector', $row->form_sequence_id)}}" class="fas fa-print nav-icon fa-2x"></a>
        </div>
        <label>
        ...
        <div>
            ...
            <p style="margin: 0cm 0cm 10pt; line-height: 115%; font-size: 11pt; font-family: Calibri, sans-serif;margin-bottom:0cm;margin-bottom:.0001pt;text-align:
                        justify;line-height:normal"><span style="font-family: Arial; font-size: 10pt;">I, </span><span style="font-family: Arial; font-size: 10pt;"><b><u>
                                ...
                                {{Str::Upper($row->name)}},
                                                </u></b></span><span style="font-family: Arial; font-size: 10pt;"> </span><span style="font-family: Arial; font-size: 10pt;"><b><u>{{Str::Upper($row->ratee_role)}} TUP-TAGUIG,</u></b></span><span style="font-family: Arial; font-size: 10pt;"></span><span style="font-family: Arial; font-size: 10pt;"><b><u>
