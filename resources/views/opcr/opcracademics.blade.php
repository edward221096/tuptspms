...
@section('opcracademics')
    ...
    <form method="POST" action="/storedataopcracademics">
        {{ csrf_field() }}
        @foreach($getmultiplier as $row)
            @if($row->function_name == 'Higher and Advanced Education Programs, Research and Technical Advisory Extension Programs, Core Administrative Functions, Support to Operations and General Administration Support')
        ...
        <input type="hidden" value="opcracademics" name="evaluationform_name[]">
...
justify;line-height:normal"><span style="font-family: Arial; font-size: 10pt;">I, </span><span style="font-family: Arial; font-size: 10pt;"><b><u>{{ Str::Upper(Auth::User()->name)}},</u></b></span><span style="font-family: Arial; font-size: 10pt;"> </span><span style="font-family: Arial; font-size: 10pt;"><b><u>{{ Str::Upper(Auth::User()->role) }}</u></b></span><span style="font-family: Arial; font-size: 10pt;"> </span><span style="font-family: Arial; font-size: 10pt;"><b><u>
                        @foreach(\App\Http\Controllers\OpcrController::getUserdata() as $getdata) {{ Str::Upper($getdata->dept_name)}}, @endforeach</u></b></span><span style="font-family: Arial; font-size: 10pt;">,
