...
@section('opcradaa')
    ...
    <form method="POST" action="/storedataopcradaa">
        ...
        @foreach($getmultiplier as $row)
            @if($row->function_name == 'Higher and Advanced Education Programs, Core Administrative Functions, General Administration and Support to Operations')
...
justify;line-height:normal"><span style="font-family: Arial; font-size: 10pt;">I, </span><span style="font-family: Arial; font-size: 10pt;"><b><u>{{Str::Upper(Auth::User()->name)}},</u></b></span><span style="font-family: Arial; font-size: 10pt;"> </span><span style="font-family: Arial; font-size: 10pt;"> </span><span style="font-family: Arial; font-size: 10pt;"><b><u>
