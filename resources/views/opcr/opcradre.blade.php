        ...
        <table cellspacing="0" cellpadding="1" style="border-collapse: collapse;" width="">
            ...
            <tr style="background-color: rgb(255, 255, 255);">
                <td style="text-align: center; border-width: 1px; border-style: solid; border-color: rgb(171, 171, 171); width: 373px;">
                    <br>
                    <br><span style="font-family: Arial; font-size: 12pt;"><b>DR. MELITO A. BACCAY</b></span>
                    <br><span style="font-size: 10pt; font-family: Arial;">Vice President for Research and Extension</span></td>
            </tr>
            </tbody>
        </table>
        <br>
