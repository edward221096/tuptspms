...
class Router implements BindingRegistrar, RegistrarContract
{
    ...
    public function auth(array $options = [])
    {
        ...
        if ($options['register'] ?? true) {
            ...
            $this->get('register', 'Auth\RegisterController@divisions')->name('register');
            $this->get('/json-department', 'Auth\RegisterController@departments');
            $this->get('/json-sections', 'Auth\RegisterController@sections');
